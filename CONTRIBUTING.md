...
* **Fluid Workflows:** Ensure that the workflow tracking engine remains responsive and intuitive.
...
3. **Description:** Explain what your PR does and why it's a good fit for Celerix Flow.

## ⚖️ License
By contributing to Celerix Flow, you agree that your contributions will be licensed under the **MIT License**.
